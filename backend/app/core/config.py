...
class Settings(BaseSettings):
    ...
    IRIS_SQL_NAMESPACE: str = "FHIRSERVER"  # Namespace where FHIR SQL Builder projections live
    # FHIR SQL Builder schema — auto-generated by IRIS for the first FHIR endpoint.
    #   X0001 = first endpoint (InstallInstance); I0001 is NOT generated by this install.
