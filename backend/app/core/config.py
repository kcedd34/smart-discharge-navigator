...
class Settings(BaseSettings):
    ...
    IRIS_SQL_NAMESPACE: str = "FHIRSERVER"  # Namespace where FHIR SQL Builder projections are created
    # FHIR SQL Builder schema — auto-generated by IRIS for the first FHIR endpoint.
    #   X0001 corresponds to the first InstallInstance call (verified against running instance).
    IRIS_FHIR_SQL_SCHEMA: str = "HSFHIR_X0001_S"
